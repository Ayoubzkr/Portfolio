...
const socialLinks = [
  ...
  {
    href: 'https://www.linkedin.com/in/ayoub-zokri-11ba5a156', 
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M20.52 3.48A10.34 10.34 0 0012 0C5.37 0 0 5.37 0 12a11.93 11.93 0 001.6 6l-1.6 6 6-1.6a11.93 11.93 0 006 1.6c6.63 0 12-5.37 12-12a10.34 10.34 0 00-3.48-8.52zM12 22a9.92 9.92 0 01-5.14-1.39l-.37-.22-3.57.95.95-3.57-.23-.37A9.92 9.92 0 012 12C2 6.48 6.48 2 12 2c2.47 0 4.78.9 6.57 2.57A9.35 9.35 0 0122 12c0 5.52-4.48 10-10 10zm5.45-5.25c-.28-.15-1.65-.81-1.9-.9s-.44-.14-.62.14-.71.9-.87 1.08-.32.21-.6.07a9.05 9.05 0 01-2.64-1.63 9.86 9.86 0 01-1.84-2.28c-.2-.34 0-.53.15-.68s.37-.43.55-.65c.17-.21.23-.35.34-.58.11-.23.06-.43-.03-.6s-.62-1.51-.85-2.06c-.22-.53-.45-.46-.62-.46-.15 0-.33 0-.52.23s-.68.66-.68 1.62a3.15 3.15 0 00.7 1.7A10.51 10.51 0 009.65 15a8.94 8.94 0 006.09 2.74c.42 0 .84-.02 1.24-.06.39-.03 1.26-.51 1.44-1.01.18-.5.18-.94.14-1.01-.04-.08-.15-.12-.43-.27z" />
      </svg>
    ),
    alt: 'WhatsApp'
  }
...
const Contact=()=>{
    return(
        ...
        <div className="container grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6">
          <div className="mb-12 lg:mb-0 lg:flex-col">
            <h3 className="headline-2 lg:max-w-[12ch]">
            Pour une collaboration, veuillez me contacter
            </h3>
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
            Prenez contact dès aujourd'hui pour discuter de vos besoins et commencer une collaboration exceptionnelle !
            </p>
          ...
          <form
            action="https://getform.io/f/bwnnmlea"
            className="xl:pl-10 2xl:pl-20 w-full max-w-md mx-auto lg:mx-0"
            method="POST"
          >
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  placeholder="ayoubzokrii@gmail.com"
                  autoComplete="email"
                  className="text-field"
                  required
                />
